...
fig.savefig('./A5 Individual design/Figures 2/Campbell_structural.svg', format='svg')
fig.savefig('./A5 Individual design/Figures 2/Campbell_structural.png', format='png')
...
amp_path = './A5 Individual design/Part 2/individual_design_structural_amp.amp'
...
rpm = 0.785398E+00  # rotational speed (update this to match the desired value from the amp file)
...
fig.savefig('./A5 Individual design/Figures 2/Campbell_structural_modal_amplitudes.svg', format='svg')
fig.savefig('./A5 Individual design/Figures 2/Campbell_structural_modal_amplitudes.png', format='png')
