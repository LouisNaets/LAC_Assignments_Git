...
opt_path = './A5 Individual design/Part 2/individual_design_flex_minrotspd.opt'
...
fig.savefig('./A5 Individual design/Figures 2/Campbell_aeroelastic.svg', format='svg')
fig.savefig('./A5 Individual design/Figures 2/Campbell_aeroelastic.png', format='png')
...
amp_path = './A5 Individual design/Part 2/individual_design_aeroelastic_amp.amp'
...
wsp = 11.1  # rated wind speed (more or less)

fig, ax = plot_amp(amp_df, mode_names, wsp, title=f'Redesigned IIIB climate turbine aeroelastic modal amplitudes at ~{wsp:.0f} m/s')

fig.savefig('./A5 Individual design/Figures 2/Campbell_aeroelastic_modal_amplitudes.svg', format='svg')
fig.savefig('./A5 Individual design/Figures 2/Campbell_aeroelastic_modal_amplitudes.png', format='png')