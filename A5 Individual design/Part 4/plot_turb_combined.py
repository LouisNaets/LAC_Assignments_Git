...
plt.savefig('./A5 Individual design/Figures 4/combined_turb_stats.svg', format='svg')
plt.savefig('./A5 Individual design/Figures 4/combined_turb_stats.png', format='png')
