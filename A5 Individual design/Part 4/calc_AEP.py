...
def AEP_data(STATS_PATH, HAWC2S_PATH, SUBFOLDER, ubar, winddist):
    ...
    print('TEST 2:', h2_power_mean_turb)
...
# analysis settings
HAWC2S_PATH_DTU = './A5 Individual design/Part 4/dtu_10mw_flex_minrotspd.opt'  # path to .pwr or .opt file
STATS_PATH_DTU = './A5 Individual design/Part 4/dtu_10mw_turb_stats.hdf5'  # path to mean steady stats
SUBFOLDER_DTU = 'tcb'  # which subfolder to plot: tca or tcb

HAWC2S_PATH_OURS = './hawc_files/individual_design/data/individual_design_flex_minrotspd.opt'  # path to .pwr or .opt file
STATS_PATH_OURS = './A5 Individual design/Part 4/individual_design_turb_tcb_stats.csv'  # path to mean steady stats
...
plt.savefig('./A5 Individual design/Figures 4/Power_curve_comparison.png', dpi=300)
plt.savefig('./A5 Individual design/Figures 4/Power_curve_comparison.svg', dpi=300)
...
# Display the plot
plt.savefig('./A5 Individual design/Figures 4/AEP_comparison.png', dpi=300)
plt.savefig('./A5 Individual design/Figures 4/AEP_comparison.svg', dpi=300)
#plt.show()
