...
CMB_PATH = './A2/group7_aeroelastic_HAWC2S.cmb'
...
fig.savefig('A2/Figures/Campbell_aeroelastic_HAWC2S.svg', format='svg')
fig.savefig('A2/Figures/Campbell_aeroelastic_HAWC2S.png', format='png')
...
amp_path = './A2/group7_aeroelastic_amp_HAWC2S.amp'
...
fig.savefig('A2/Figures/Campbell_aeroelastic_modal_amplitudes_HAWC2S.svg', format='svg')
fig.savefig('A2/Figures/Campbell_aeroelastic_modal_amplitudes_HAWC2S.png', format='png')