...
class WT_:
    ...
    def __init__(self, Model, SimParams):
        self.Model = Model
        # load cp table
        self.tsr_grid = pd.read_csv('./A3/Control/WT_Data/DTU10MW/tsr_grid.csv')
        self.pitch_grid = pd.read_csv('./A3/Control/WT_Data/DTU10MW/pitch_grid.csv')
        self.CP_grid = pd.read_csv('./A3/Control/WT_Data/DTU10MW/CP.csv')
        self.CT_grid = pd.read_csv('./A3/Control/WT_Data/DTU10MW/CT.csv')
