...
def plot_wind_turbine_data(c1, c2, c3, title: str, omega1: str, omega2: str, zeta1: str):
    ...
    axs[0, 0].plot(c1["time"], c1["wind_speed"], label='$ω_Ω$=0.05 Hz & $ζ_Ω=0.7 $')
    axs[0, 0].plot(c2["time"], c2["wind_speed"], label=f'$ω_Ω$={omega1} Hz & $ζ_Ω={zeta1} $')
    axs[0, 0].plot(c3["time"], c3["wind_speed"], label=f'$ω_Ω$={omega2} Hz & $ζ_Ω={zeta1} $')
...
#----------------to plot controller C7 options 1-8-----------------
