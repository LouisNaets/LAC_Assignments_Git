...
plt.savefig('./A4 Design Loads and AEP/Assignment/Figures/group7_tcb.svg', format='svg')
plt.savefig('./A4 Design Loads and AEP/Assignment/Figures/group7_tcb.png', format='png')